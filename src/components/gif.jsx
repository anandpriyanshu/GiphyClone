    ...
    return (
        <Link to={`/${gif.type}s/${gif.slug}`}>
            ...
            <div className='w-full mb-2 relative cursor-pointer group aspect-video'>
                ...
                {
                    hover && (
                        <div className='absolute inset-0 rounded opacity-0 group-hover:opacity-100 bg-gradient-to-b from-transparent to-transparent to-black font-bold flex items-end gap-2 p-2'>
                            <img
